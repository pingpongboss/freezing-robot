...
var Faceplate = function (options) {
  ...
  this.nonbrowser_session = function (fbId, cb) {
    ...
    users.getUser(fbId, function (data) {
  ...
  this.parse_signed_request = function (signed_request, cb) {
    ...
    var data = JSON.parse(json);
            ...
            if (sig !== expected_sig) throw ("bad signature");
            ...
            if (!data.code) throw ("no oauth token and no code to get one");
        ...
        var FaceplateSession = function (plate, token) {
          ...
          this.get = function (path, params, cb) {
            ...
            if (self.token && !params.access_token) params.access_token = self.token;
          ...
          this.fql = function (query, cb) {
            restler.get('https://api.facebook.com/method/fql.query', {
              query: {
          ...
          this.post = function (path, params, cb) {
            ...
            restler.post('https://graph.facebook.com/' + path, {
              data: params
            }).on('complete', function (data) {
              var result = JSON.parse(data);
